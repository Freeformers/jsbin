...
module.exports = function (app) {
  ...
  // TODO `key` should be pulled in from config, as should URL to push updates to.
  ...
  var events = binSubject.window(
    function() { return Rx.Observable.timer(20 * 1000); }
  ).flatMap(
    function(window) {
  ...
  events.subscribe(
    function(stuff) {
      return fetch(
        'http://127.0.0.1:3030/bin-updates/',
        {
          method: 'post',
          headers: {
